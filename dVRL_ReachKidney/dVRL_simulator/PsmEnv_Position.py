...
from dVRL_simulator.vrep.simObjects import table, rail, target, targetK
...
class PSMEnv_Position(PSMEnv):
	...
	def __init__(self, psm_num, n_substeps, block_gripper, has_object, 
			target_in_the_air, height_offset, target_offset, obj_range, target_range,
			...
			randomize_initial_pos_kidney, randomize_initial_or_kidney):
